...
public class DataAccessFacade implements DataAccess {
	...
	public void saveNewMember(LibraryMember member) {
		...
		// HashMap<String, LibraryMember> membermap = new HashMap<String,
		// LibraryMember>();
		...
		alert.setContentText("Library Member Successfully added");
		alert.showAndWait();
	...
	public void updateMember(LibraryMember member) {
		HashMap<String, LibraryMember> membermap = readMemberMap();
		if (membermap.containsKey(member.getMember_ID())) {
...
//	@SuppressWarnings("unchecked")
//	public HashMap<String, LibraryMember> readMemberMap(LibraryMember librarymember) {
//		return (HashMap<String, LibraryMember>) readFromStorage(StorageType.MEMBERS);
//	}
